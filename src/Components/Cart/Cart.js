            ...
            <div className="full-cart">
                ...
                { !cart.length ? <h4 className="text-center mt-5">Cart Empty</h4> :
                    ...
                    <Col lg={4} md={4} sm={4} xs={4} className="d-flex align-items-center">
                        ...
                        {/* cart item remove  */}
                        <button onClick={() => handleRemoveCartItem(product)} className="text-decoration-underline d-inline bg-transparent border-0 p-0 m-0"><i className="fa fa-times-circle"></i></button> 
